...
Mobile.setText(findTestObject('Object Repository/1 - Register Valid/android.widget.EditText'), 'Tasya Fitria Anggraini', 
    0)

Mobile.setText(findTestObject('Object Repository/1 - Register Valid/android.widget.EditText (1)'), 'tasyafangg@gmail.com', 
    0)
