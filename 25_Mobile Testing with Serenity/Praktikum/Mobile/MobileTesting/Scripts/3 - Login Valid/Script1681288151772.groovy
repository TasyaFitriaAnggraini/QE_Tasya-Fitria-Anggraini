...
Mobile.setText(findTestObject('Object Repository/3 - Login Valid/android.widget.EditText'), 'Tasya Fitria Anggraini', 0)

Mobile.setText(findTestObject('Object Repository/3 - Login Valid/android.widget.EditText (1)'), 'tasyafangg@gmail.com', 
    0)
...
Mobile.setText(findTestObject('Object Repository/3 - Login Valid/android.widget.EditText (4)'), 'tasyafangg@gmail.com', 
    0)
